(function () {
    ...
    angular.module('HousePointsApp', ['ui.router', 'ngCookies', 'restangular', 'ngAnimate', 'LocalStorageModule', 'ngAria', 'ngMaterial'])
        ...
        .config(["$stateProvider", "$urlRouterProvider", "$locationProvider", "$httpProvider", "$animateProvider", "$compileProvider", function ($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider, $animateProvider, $compileProvider) {
            ...
            isAlreadyLoggedIn.$inject = ["AuthService", "$q", "StorageService"];
...
(function (app) {
    'use strict';
    app.directive('usernameAvailableValidator', ["$q", "$timeout", "UserService", function ($q, $timeout, UserService) {
        return {
            restrict: 'A',
            require: 'ngModel',
...
(function (app) {
    'use strict';
    app.factory('AuthService', ["$http", "$q", "UserService", "StorageService", function ($http, $q, UserService, StorageService) {
...
(function (app) {
	'use strict';
    app.controller('addChildController', ["$state", "$log", "KidsService", function($state, $log, KidsService) {
        var vm = this;
        vm.child = {
            name: ''
        };
...
(function (app) {
    'use strict';
    app.directive('parentView', ["$state", "$log", function ($state, $log) {
        return {
            restrict: 'E',
